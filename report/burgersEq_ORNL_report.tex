...
\documentclass[ltr]{ornltm-app-mod} % Use for LTR report.
%\documentclass[ltr]{ornltm} % --> USE THIS FOR FUTURE REPORTS
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Back cover page --> UNCOMMENT FOR FUTURE WORK
%    \backmatter
